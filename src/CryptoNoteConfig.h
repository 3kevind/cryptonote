...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = Zhi0x41c3;
...
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 10000;
...
const char     CRYPTONOTE_NAME[]                             = "Runes";
...
const int      P2P_DEFAULT_PORT                              = 45455;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 45456;
